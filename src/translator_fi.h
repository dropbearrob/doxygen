...
//////////////////////////////////////////////////////////////////////////
    ...
    {
      return "Tässä on luettelo kaikista vaatimuksista lyhyine kuvauksineen:";
    }

    /*! Used in traceability index */
    QCString trTraceabilityDescription() override
    {
      return "Tässä on jäljitettävyystiedot kaikista vaatimuksista:";
    }

...
//////////////////////////////////////////////////////////////////////////
    ...
    {
      return "Ето списък на всички изисквания с кратки описания:";
    }

    /*! Used in traceability index */
    QCString trTraceabilityDescription() override
    {
      return "Ето информация за проследимост за всички изисквания:";
    }

...
//////////////////////////////////////////////////////////////////////////
    ...
    {
      return "Voici une liste de toutes les exigences avec de brèves descriptions:";
    }

    /*! Used in traceability index */
    QCString trTraceabilityDescription() override
    {
      return "Voici les informations de traçabilité pour toutes les exigences:";
    }

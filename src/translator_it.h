...
//////////////////////////////////////////////////////////////////////////
    ...
    {
      return "Soddisfatto da";
    }

    /*! Used in traceability table header */
    QCString trVerifiedBy() override
    {
      return "Verificato da";
    }
    ...
    {
      return "Ecco un elenco di tutti i requisiti con brevi descrizioni:";
    }

    /*! Used in traceability index */
    QCString trTraceabilityDescription() override
    {
      return "Ecco le informazioni di tracciabilità per tutti i requisiti:";
    }

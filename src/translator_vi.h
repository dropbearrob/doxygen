...
//////////////////////////////////////////////////////////////////////////
    ...
    {
      return "Đây là danh sách tất cả các yêu cầu với mô tả ngắn:";
    }

    /*! Used in traceability index */
    QCString trTraceabilityDescription() override
    {
      return "Đây là thông tin khả năng truy xuất cho tất cả các yêu cầu:";
    }

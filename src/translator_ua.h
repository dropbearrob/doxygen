...
//////////////////////////////////////////////////////////////////////////
    ...
    {
      return "Ось список усіх вимог з короткими описами:";
    }

    /*! Used in traceability index */
    QCString trTraceabilityDescription() override
    {
      return "Ось інформація про простежуваність для всіх вимог:";
    }

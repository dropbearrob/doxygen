...
//////////////////////////////////////////////////////////////////////////
    ...
    {
      return "در اینجا لیستی از تمام نیازمندی‌ها با توضیحات مختصر آمده است:";
    }

    /*! Used in traceability index */
    QCString trTraceabilityDescription() override
    {
      return "در اینجا اطلاعات قابلیت ردیابی برای تمام نیازمندی‌ها آمده است:";
    }

...
//////////////////////////////////////////////////////////////////////////
    ...
    {
      return "Här är en lista över alla krav med korta beskrivningar:";
    }

    /*! Used in traceability index */
    QCString trTraceabilityDescription() override
    {
      return "Här är spårbarhetsinformation för alla krav:";
    }
